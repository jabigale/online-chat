...
$sql1 = "INSERT INTO `users` (`u`,`p`,`aid`) VALUES (:username, :password, :aid)";
      // Prepare the SQL query
$sth1 = $dbh->prepare($sql1);
      // Bind parameters to statement variables
$sth1->bindParam(':username', $username);
$sth1->bindParam(':password', $pw);
$sth1->bindParam(':aid', $aid);
      // Execute statement
$sth1->execute();
}
...
<table class="naccounttable">
<tr><td>username:</td><td><input type="textbox" name="username"></td></tr>
<tr><td>name:</td><td><input type="textbox" name="name"></td></tr>
<tr><td>password:</td><td><input typ="textbox" name="password"></td></tr>
<tr><td>Select image to upload:</td><td>
    <input type="file" name="fileToUpload" id="fileToUpload"></td></tr>
<tr><td></td><td><input type="submit" name="newaccountsubmit" value="Create Account"></td></tr>
</table>
