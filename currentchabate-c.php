...
$avatar = $row2['avatar'];
$name = $row2['name'];
echo "<tr><td rowspan=\"3\" width=\"54\"><img src=\"/chabate/images/avatars/".$avatar.".png\" class=\"left\" width=\"40\" /></td><td><a href=\"account.php?uid=".$userid."\" ><font size=\"2em\" color=\"blue\">".$name."</font></a>&nbsp;&nbsp;<font size=\"0.75em\">".$ndate."</font></td></tr>\n";
